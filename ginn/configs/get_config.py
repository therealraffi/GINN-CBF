...
def read_cli_args_and_get_config():
    ...
    parser.add_argument("--no_save", help="Do not save the current run's weights", type=bool, default=False)
    ...
    if args.hp_dict:
        ...
        print(" my hp_dict ", args.hp_dict)
        print(" my hp_dict_arg_dict ", hp_dict_arg_dict)
        print(" my overwrite_hps ", overwrite_hps)
    ...
    print("Using dataset:", config['dataset_dir'])
    print("Using model_save_path:", config['model_save_path'])
    return config
