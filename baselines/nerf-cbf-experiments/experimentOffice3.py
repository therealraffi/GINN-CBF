...
class Robot:
    def __init__(self, cfg):
        self.c = np.load('office3.npy',allow_pickle=True).item()
        self.decoders = torch.load('office3.pth')
...
if __name__ == '__main__':
    ...
    file_path = '/home/nqd2xs/nerf_cbf_controller/office_3_start_goal.csv'
    ...
    for start, goal in position_pairs:
        ...
        np.savetxt(f"/home/nqd2xs/nerf_cbf_controller/trajectories/office3/trajectory{traj_counter}.txt", traj_array, delimiter=",", header=f"Execution time: {end_time - start_time:.4f} seconds")
        traj_counter += 1
